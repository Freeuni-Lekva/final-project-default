...
<head>
    <%
        ...
        ArrayList<Quiz> recentQuizCreationActivities;
        List<AchievementHistory> userAchievements;
        List<Mail> userIncomingRecentMails;
        ArrayList<Quiz> recetQuizTakeActivity;

        //friends activities
        List<User> friends;
        HashMap<User, Quiz> friendRecentQuizzesTaken;
        HashMap<User, Quiz> friendRecentQuizCreatingActivities;
...
<div class="form">
    ...
    <input class="tabs" type="button" name="Showdiv6" value="My Messages" onclick="showDiv('6')"/>
    ...
    <div id=div6>
        <table class="topscorers">
            ...
            <%
                for (Mail mail : userIncomingRecentMails) {
                    if (mail.getType().equals("NOTE")) {
                        out.println("<tr><td>" + us.getUser(mail.getFromId()).getUsername() + "</td><td>" + mail.getDate().toString() + "</td><td>" + mail.getTitle() + "</td><td>" + mail.getContent() + "</td></tr>");
                    }
                }%>
        </table>
    </div>
