...
<div class="form">
    <form action="../AddQuestionResponseQuestionServlet" id="AddQuestionResponse" method="post">
        <h1>Question:</h1>
        <textarea form="AddQuestionResponse" maxlength="500" id="questionDescription" name="questionDescription"
                  cols="15"></textarea><br><br><br><br><br>
        <h4>Please, Write Answers. Separate Each Answer With Comma.</h4>
        <textarea form="AddQuestionResponse" maxlength="500" id="answer" name="answer" cols="15"></textarea><br><br><br><br><br><br>
        <input class="button1" form="AddQuestionResponse" type="submit" id="addQuestionButton" name="addQuestionButton"
               value="Add">
    </form>
</div>
